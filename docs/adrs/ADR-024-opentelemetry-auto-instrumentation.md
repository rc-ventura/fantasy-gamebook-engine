# ADR-024: OpenTelemetry auto-instrumentation + no-PII-in-spans rule

**Status**: Accepted | **Date**: 2026-06-28 | **Branch**: `feat/004-auth-obs`

> Renumbered from slice 004's ADR-019 by spec 006 (ADR-020 numbering policy) — the original numbers collided with ADRs 017-019 on `dev`.
